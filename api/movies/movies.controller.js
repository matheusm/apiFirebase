...
module.exports = {
    ...
    getMoviesById : function(req,res){
    ...
    getMoviesByName : function(req,res){
    ...
    getMoviesByAutor : function(req,res){
    ...
    createMovies : function(req,res){
        ...
        ref.once('value',
            (resposta)=>{
                ...
                if (!series) {
                    series = [];
                    ref = admin.database().ref('/movies').child('0');
